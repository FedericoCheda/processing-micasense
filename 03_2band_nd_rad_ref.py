...
#Procesado banda verde (2)
imgs = glob.glob(os.path.join(imagePath, "*2.tif"))
for img in imgs:
...
metadataBat = os.path.join(dirBAT,"02_metadata_green.bat")
