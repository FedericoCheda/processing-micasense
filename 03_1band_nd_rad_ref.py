...
#Procesado banda azul (1)
imgs = glob.glob(os.path.join(imagePath, "*1.tif"))
for img in imgs:
...
metadataBat = os.path.join(dirBAT,"01_metadata_blue.bat")
