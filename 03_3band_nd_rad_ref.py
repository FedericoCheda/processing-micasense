...
targetName = filedialog.askopenfilename(parent=root,
    ...
    title='Seleccionar el blanco: banda rojo')
root.destroy()
print(targetName)
...
#Procesado banda roja (1)
imgs = glob.glob(os.path.join(imagePath, "*3.tif"))
for img in imgs:
...
metadataBat = os.path.join(dirBAT,"03_metadata_red.bat")
